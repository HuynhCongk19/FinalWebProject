...
<jsp:useBean id="products" scope="request" type="java.util.List<com.ute.FinalProject.beans.Product>"/>
<t:main>
    <jsp:body>
        <div class="card">
                                ...
                                <div class="col-sm-4 mb-3">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-footer text-muted">
                                            <a class="btn btn-sm btn-outline-primary" href="${pageContext.request.contextPath}Admin/Product/Detail?id=${c.proID}" role="button">
